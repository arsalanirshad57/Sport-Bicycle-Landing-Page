...
const ProductImage = () => {
  return (
    <div className='hidden xl:block relative w-5/12 '>
      ...
      <img src={Bar} alt="bar" className='absolute w-3 h-screen bottom-0' />
      <img src={Image} alt="image" className="hidden lg:block h-full  pl-3 absolute bottom-0 " />
    </div>
  )
}
