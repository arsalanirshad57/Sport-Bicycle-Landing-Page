    ...
    return (
        <>
            <div className=" md:hidden ">   
                <div className="cursor-pointer absolute right-4 sm:right-8 top-7 z-50 " onClick={() => setOpenNav(!openNav)}>
                    {openNav ? (
